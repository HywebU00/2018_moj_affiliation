$(function() {
    ...
    $('header .container').append('<button type="button" class="sidebarCtrl" aria-haspopup="true" aria-expanded="false">側欄選單</button><button type="button" class="searchCtrl" aria-expanded="false" title="' + SearchTitle + '">查詢</button>');
